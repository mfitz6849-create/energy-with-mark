(() => {
  ...
  const NATIVE_BILL_UPLOAD_ENDPOINT = 'https://api.energywithmark.com.au/api/public/website-intake/v1?upload=bill-file';
  const BILL_RECEIPT_ENDPOINT = 'https://api.energywithmark.com.au/api/public/website-intake/v1?receipt=bill';
